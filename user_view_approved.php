...
<div class="card text-center text-body">
  ...
  <h2 > <h1 >My Approved Application Requests</h1></h2>
  </div> 
    <div class="card-body">
        <table class="table table-dark table-striped">
          ...
          <?php
					 	$result ="SELECT tbl_leave.numberofdays, tbl_leave_type.leave_type, users.id,users.department,tbl_leave.daterequested,
                         ...
                         on tbl_leave.leave_type=tbl_leave_type.id where tbl_leave.leave_status='approved' AND users.id=".$_SESSION['user']['id']."  ";
// $result =  "SELECT tbl_leave_type.leave_type, users.id,users.department,tbl_leave.daterequested,
//                          tbl_leave.leave_start,tbl_leave.leave_end,users.firstname,users.lastname,
//                          tbl_leave.leave_status FROM tbl_leave INNER JOIN users ON users.id=tbl_leave.id INNER JOIN tbl_leave_type ON tbl_leave.leave_id= tbl_leave_type.id where tbl_leave.leave_status='approved' AND users.id=".$_SESSION['user']['id']."  ";
