...
<header class="mb-auto">
  ...
  <?php if (isset($_SESSION['success'])) : ?>
    ...
    <h3 >List of All Leave Application</h3><br />
    <table class="table table-dark table-striped"> 
              ...
              <td>Full Name</td>
						...
						<?php
					 	$result ="SELECT  numberofdays, users.id,users.department,
             tbl_leave.daterequested,tbl_leave.leave_start,tbl_leave.leave_end,
             users.firstname,users.lastname,tbl_leave.leave_status          
                         FROM tbl_leave 
                         INNER JOIN users          
